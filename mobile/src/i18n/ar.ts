...
const AR = {
  ...
  errors: {
    ...
    shop_weekly_limit: 'وصلت للحد الأسبوعي للإعلانات. تكدر تنشر من لوحة المتجر أو تنتظر تحرّر مكان.',
    ...
    seller_no_contact: 'هذا البائع لا يستقبل رسائل داخل التطبيق — اتصل به مباشرة.',
