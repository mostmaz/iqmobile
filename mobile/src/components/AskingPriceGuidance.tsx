...
export function AskingPriceGuidance({askingPrice,...filters}:Props) {
  ...
  return <View style={{padding:14,marginBottom:12,gap:7,borderWidth:1,borderColor:theme.line,borderRadius:radius.lg,backgroundColor:theme.surface}}>
    ...
    <Text style={style}>لنفس الموديل والسعة والحالة في محافظتك، من الإعلانات النشطة خلال آخر 30 يوماً.</Text>
    {!ready ? <Text style={style}>اختر الموديل والسعة والحالة والمحافظة لعرض المقارنة.</Text>
    ...
    <Text style={{...style,fontSize:12}}>هذه أسعار يطلبها البائعون، وليست أسعار صفقات مكتملة أو تقييماً مضموناً لجهازك. قد تختلف الملحقات والضمان والتفاصيل. السعر النهائي قرارك.</Text>
  </View>;
}
