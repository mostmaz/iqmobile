...
const insEvent = db.prepare(
  `INSERT INTO events(type, listing_id, user_id, brand, governorate, query, result_count, created_at)
   VALUES(@type, @listing_id, @user_id, @brand, @governorate, @query, @result_count, @created_at)`,
);
