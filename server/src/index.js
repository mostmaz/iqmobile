...
import seoFileRoutes from './routes/seoFiles.js';
...
// Before the web pages: /robots.txt and /sitemap*.xml are files, not
// marketplace routes, and webHome's '/' would otherwise swallow them.
